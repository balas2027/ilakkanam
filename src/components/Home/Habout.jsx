...
function Habout() {
  return (
    // xl:sticky xl:top-0
    <section className="bg-gradient-to-b relative group my-5 w-full flex justify-center  min-h-screen py-12 lg:py-20">
...
<div className="absolute h-52 z-10 top-0 w-full rounded-b-full transition-transform duration-500 origin-center scale-x-0 group-hover:scale-x-100 bg-gradient-to-b from-blue-200 via-blue-100/10 to-blue-100/1 pointer-events-none"></div>     
      <div className="container mx- px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        {/* Image Section - Tilted Card Style */}
          <div className="flex-1 flex items-center justify-center  lg:justify-start">
            <div className="relative w-full flex justify-center lg:justify-start">
              ...
              <div className="relative transform group-hover:rotate-0 lg:-rotate-3 hover:rotate-0 transition-transform duration-500 ease-out">
                <div className="bg-white p-3 sm:p-4 md:p-6 rounded-2xl shadow-2xl hover:shadow-3xl transition-shadow duration-500">
                  <img 
                    src={about} 
                    alt="About Ilakkanam - Innovation in Engineering" 
                    className="w-64 h-48 sm:w-100 sm:h-60 md:w-120 md:h-72 lg:w-100 lg:h-100 xl:w-120 xl:h-120 object-cover rounded-xl"
                    loading="lazy"
                  />
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-tl border border-cyan-100 animate-pulse from-pink-50 via-pink-100 to-pink-50 absolute -top-8 -right-8 sm:-top-10 sm:-right-10 -z-10 rounded-full"></div>
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-tl border border-pink-100 animate-pulse from-cyan-50 via-cyan-100 to-cyan-50 absolute -bottom-8 -left-8 sm:-bottom-10 sm:-left-10 -z-10 rounded-full"></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold leading-tight text-slate-800">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600"> People Love to Use.</span>
                  </h1>
                  
                  <p className="text-sm sm:text-base lg:text-lg text-slate-600 leading-relaxed">
                    At Ilakkanam, we're driven by innovation, research, and a passion for engineering solutions. We collaborate with institutions and industries to create impactful technologies and products that shape a better future.
                  </p>
                </div>

                {/* Vision & Goal Cards */}
                <div className="xl:flex flex-col hidden sm:flex-row gap-4 mt-8">
                  <div className="flex-1 bg-gradient-to-br from-pink-50/30 to-red-50/30 p-4 rounded-lg border border-pink-100/50">
                    ...
                    <p className="text-sm text-slate-600">Innovation-driven solutions that transform industries and create lasting impact.</p>
                  </div>
                  ...
                  <div className="flex-1 bg-gradient-to-br from-blue-50/30 to-cyan-50/30 p-4 rounded-lg border border-blue-100/50">
                    ...
                    <p className="text-sm text-slate-600">Engineering excellence through collaborative research and cutting-edge technology.</p>
                  </div>
                </div>
